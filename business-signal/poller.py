#!/usr/bin/env python3
"""
Business Signal — Daily RSS Poller & Dashboard Generator
(73 Intelligence · Powered by NOAH)

Polls the RSS feed for the 5 daily Corporate Standing Briefs,
parses their content, generates per-arena HTML reports and
updates the main dashboard index.html.

Cloned from Business Signal — adapted for corporate entity tracking.

Usage:
  python3 poller.py              # Poll once, generate if all 5 ready
  python3 poller.py --wait       # Poll every 5 min until all 5 arrive
  python3 poller.py --date 2026-02-25  # Target a specific date
"""
...
def fetch_rss():
    ...
    req = urllib.request.Request(RSS_URL, headers={"User-Agent": "BusinessSignal/1.0"})
...
def parse_report_content(desc_html):
    ...
    - Executive summary
    - Corporate Perception Dashboard (propositions + scores)
    ...
    # ─── Section 5: Corporate Profile Snapshot ───
...
def fetch_predictions_from_rendered(guid):
    ...
    # Derive the base domain from the RSS_URL
    rss_domain = re.search(r'https?://([^/]+)', RSS_URL)
    base_domain = rss_domain.group(1) if rss_domain else "makes.news"
    url = f"https://{base_domain}/view/" + guid
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "BusinessSignal/1.0"})
...
html, body {{ width: 1200px; height: 630px; overflow: hidden; background: #141929; }}
.card {{ width: 1200px; height: 630px; background: #141929; position: relative; overflow: hidden; display: flex; flex-direction: column; align-items: center; justify-content: center; }}
.flag {{ position: absolute; top: 0; left: 0; right: 0; bottom: 0; background:
    radial-gradient(ellipse 120% 80% at 80% 30%, rgba(53,56,255,0.12) 0%, transparent 60%),
    radial-gradient(ellipse 80% 120% at 20% 80%, rgba(207,166,76,0.08) 0%, transparent 50%);
  opacity: 1; }}
.overlay {{ position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(24,29,53,0.55); }}
.brand {{ position: relative; z-index: 2; text-align: center; margin-top: -30px; }}
.title {{ font-family: 'Montserrat', sans-serif; font-size: 160px; font-weight: 700; color: #FFFFFF; letter-spacing: 0.30em; text-transform: uppercase; }}
...
<div class="card">
  ...
  <div class="brand">
    ...
    <div class="subtitle">Business Signal</div>
  </div>
</div>
</body></html>"""
...
def _build_dashboard_html(target_date, display_date, composite, composite_delta,
    ...
    for key, pillar in PILLARS.items():
        ...
        report_href = f"bs-{key}-{target_date}.html"
    ...
    for key in sorted_pillar_keys:
        ...
        report_file = f"bs-{key}-{target_date}.html"
...
<title>73 Intelligence — Business Signal</title>
<meta property="og:title" content="73 Intelligence — Business Signal">
<meta property="og:description" content="Daily intelligence on corporate perception and standing — perception analysis, trend monitoring, and forward predictions across five corporate arenas.">
<meta property="og:image" content="https://ivanmassow.github.io/client-reports/business-signal/og-card.png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:type" content="website">
<meta property="og:url" content="https://ivanmassow.github.io/client-reports/business-signal/">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="73 Intelligence — Business Signal">
<meta name="twitter:description" content="Daily intelligence — sentiment, trends & predictions">
<meta name="twitter:image" content="https://ivanmassow.github.io/client-reports/business-signal/og-card.png">
...
<div class="hero">
  ...
  <div class="hero-inner">
    <div class="hero-left">
      <div class="hero-eyebrow">{ENTITY_NAME}</div>
      <h1 class="hero-title">Business<br>Signal Overview</h1>
      <div class="hero-subtitle">Perception, Trends &amp; Predictions</div>
      <p class="hero-desc">Daily intelligence tracking {ENTITY_NAME}&rsquo;s external positioning &mdash; perception analysis, trend monitoring, and forward predictions across five corporate arenas.</p>
    ...
    <div class="score-block">
      <div class="score-block-inner">
        <div class="score-block-label">Composite Perception Score</div>
...
<div class="methodology-box">
  <div class="methodology-box-inner">
    <div class="methodology-box-text">Business Signal applies narrative signal processing to over 1.6 million sources daily &mdash; reducing billions of data points into actionable intelligence on sentiment, trends, and predictions.</div>
...
<div class="footer">
  <div class="footer-inner">
    <div class="footer-left">
      ...
      <span class="footer-label">Business Signal</span>
    </div>
  ...
  <div class="footer-credit">
    Intelligence architecture by Noah Wire Services &middot; Prepared for 73 Strings
  </div>
</div>
...
def generate_pillar_report(key, pillar, pdata, target_date, report_link):
    ...
    headline = f"{pillar['name']} — Business Signal"
...
{rows}        </tbody>
  ...
  <div class="sec">
    <div class="sec-head">
      <h2 class="sec-title">Corporate Profile Snapshot</h2>
  ...
  <div class="source-section">
    <div class="source-inner">
      ...
      <p class="source-text">This report was generated from the Corporate Standing Brief intelligence template produced by the Noah analytical pipeline. The raw template used to generate this report is available below.</p>
...
<meta property="og:url" content="https://ivanmassow.github.io/client-reports/business-signal/bs-{key}-{target_date}.html">
<meta name="twitter:card" content="summary_large_image">
...
<style>
:root {{
  --slate: #181D35; --slate-deep: #141929; --slate-mid: #282D45;
  --accent: #CFA64C; --accent-light: #EDE0B8;
...
/* Hero accent line */
.hero-accent {{ position: absolute; top: 0; left: 0; right: 0; height: 3px; background: linear-gradient(to right, #FFD32B, #3538FF); z-index: 4; }}
/* Subtle grid pattern in hero */
.hero-bg::before {{ content: ''; position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-image: linear-gradient(rgba(255,255,255,0.015) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.015) 1px, transparent 1px); background-size: 48px 48px; }}
...
.score-block-inner {{ background: rgba(24,29,53,0.45); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; padding: 24px 20px 20px; text-align: center; }}
...
.footer::before {{ content: ''; display: block; height: 2px; background: linear-gradient(to right, #FFD32B, #3538FF); margin: -28px -32px 28px; }}
...
<div class="hero">
  ...
  <div class="hero-inner">
    <div class="hero-left">
      ...
      <div class="hero-meta">{ENTITY_NAME} &mdash; {display_date} &middot; Ref: {ref_code}</div>
      <p class="hero-desc">{html.escape(_fix_emdashes(exec_summary[:200]))}</p>
    </div>
    <div class="score-block">
      <div class="score-block-inner">
        <div class="score-block-label">Arena Score</div>
...
{exec_html}    </div>
  ...
  <!-- Section 04: Corporate Perception Dashboard -->
  <div class="sec">
    <div class="sec-head">
      <h2 class="sec-title">Corporate Perception Dashboard</h2>
  ...
  <!-- Section 06: Corporate Standing Context -->
  <div class="sec">
    <div class="sec-head">
      <h2 class="sec-title">Corporate Standing Context</h2>
...
<div class="footer">
  ...
  <div class="footer-credit">Intelligence architecture by Noah Wire Services &middot; Prepared for 73 Strings</div>
</div>

</body>
</html>"""

    filename = f"bs-{key}-{target_date}.html"
...
def run_once(target_date, require_all=True):
    ...
    """
    print(f"\n{'='*60}")
    print(f"  Business Signal Poller — {target_date}")
...
def main():
    parser = argparse.ArgumentParser(description="Business Signal RSS Poller")
