...
.hero-inner {{ max-width: 1100px; margin: 0 auto; position: relative; z-index: 2; display: flex; align-items: flex-start; justify-content: space-between; padding: 60px 32px 40px; min-height: 395px; }}
...
.hero-title {{ font-family: 'Lora', Georgia, serif; font-size: 36px; font-weight: 700; color: rgba(255,255,255,0.92); line-height: 1.15; margin-bottom: 10px; }}
